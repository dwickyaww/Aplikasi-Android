package com.example.tesandroid;
...
import com.example.tesandroid.response.BeritaItem;
...
class AdapterBerita extends RecyclerView.Adapter<AdapterBerita.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        // Dapatkan url gambar
        final String urlGambarBerita = "https://jsonplaceholder.typicode.com/todos/{id}" + berita.get(position).getFoto();
